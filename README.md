...
>
> > **Desempenho — Huge Pages:** se o daemon reportar `normal memory pages, hashrate will be lower`, rode `python minerar.py --large-pages` (como administrador) para ativar páginas grandes de memória — o hashrate do CNA v6 melhora bastante. Saia e entre no Windows depois.
